                    ...
                    <script>
                        Highcharts.chart('td-by-dist', {
                            ...
                            series: [
                                ...
                                data: [
                                <?php foreach($tds_by_dist as $distance => $tds): ?>
                                    <?php if (isset($pats_tds_by_dist[$distance])) { 
                                        print count($pats_tds_by_dist[$distance]); 
                                    } else {
                                        print '0';
                                    }?>,
                                <?php endforeach; ?>
                    ...
                    <script>
                        Highcharts.chart('td-by-air-yds', {
                            ...
                            series: [
                                ...
                                data: [
                                <?php foreach($tds_by_air_yds as $distance => $tds): ?>
                                    <?php if (isset($pats_tds_by_air_yds[$distance])) { 
                                        print count($pats_tds_by_air_yds[$distance]); 
                                    } else {
                                        print '0';
                                    }?>,
                                <?php endforeach; ?>
